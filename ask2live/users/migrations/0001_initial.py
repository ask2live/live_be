    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_open_auth', models.BooleanField(blank=True, default=False)),
                ...
                ('social_account', models.CharField(blank=True, choices=[('instagram', 'Instagram')], max_length=50, null=True)),
